...
function usage () {
        ...
        echo "   device/hardkernel/$PROJECT_NAME/quick_build_kernel.sh bootimage      --> build uImage"
        echo "   device/hardkernel/$PROJECT_NAME/quick_build_kernel.sh recoveryimage  --> build recovery uImage"
        echo "   device/hardkernel/$PROJECT_NAME/quick_build_kernel.sh menuconfig     --> go menuconfig"
        echo "   device/hardkernel/$PROJECT_NAME/quick_build_kernel.sh saveconfig     --> savedefconfig"
}
